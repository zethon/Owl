...
void OwlUtilsTests::PreviewTextTest()
{
    ...
    QCOMPARE(owl::previewText(longText), QString{ "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut..." });
    QCOMPARE(owl::previewText(longText, 20), QString{ "Lorem ipsum dolor..." });
}
